import configparser
from spelltutor.utils.general_util import get_resource_path


class PropertyUtil:
    def __init__(self, prop_file_name, section_name):
        #print("Prop file name is : {} and section_name is {}".format(prop_file_name, section_name))
    ...
    def get_config_parser_obj(self):
        ...
        #print("resource path is : {}".format(get_resource_path(self._prop_file_name)))
